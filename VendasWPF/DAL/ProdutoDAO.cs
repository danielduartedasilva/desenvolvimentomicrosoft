...
namespace VendasWPF.DAL
{
    class ProdutoDAO
    {
        ...
        public static Produto BuscarPorNome(string nome) =>
            _context.Produtos.FirstOrDefault(x => x.Nome == nome); //x representa cada linha na tabela de produtos
        ...
        public static List<Produto> Listar() => _context.Produtos.ToList();
