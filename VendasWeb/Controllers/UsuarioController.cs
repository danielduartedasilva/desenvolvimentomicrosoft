...
namespace VendasWeb.Controllers
{
    ...
    public class UsuarioController : Controller
    {
        ...
        {//---------------------------------------------------------------------------------------------------------------------------Bind serve para dizer quais são os campos que virão da view
            if (ModelState.IsValid)
            {
                ...
                IdentityResult resultado = await _userManager.CreateAsync(usuario, usuarioView.Senha); //---------------------------------------------------------------------------------------CreateAsync vai permitir cadastrar o usuário na tabela que foi gerada automaticamente
